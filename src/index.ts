...
import { SimubClient } from './simub-client.js';
...
const BASE_URL = process.env.SIMUB_BASE_URL || process.env.SIMUB_BASE_URL || 'https://api.simub.com';
...
const client = new SimubClient(API_KEY, BASE_URL);
...
async function main() {
  ...
  console.error('Simub MCP server running...');
}
